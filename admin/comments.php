            ...
            <div class="col l12 m12 s12 center">
                ...
                <ul class="collection with-header">
                    ...
                    if(mysqli_num_rows($res3) > 0)
                    {
                        ...
                        {
                            $post = $row3['id'];
                            $sql4 = "select * from comments where post_id = $post order by id desc";
                    ...
                    <li class="collection-item #f5f5f5 grey lighten-4">
                        ...
                        <br><br>
                        <span><a href="#modal<?php echo $row4['id']; ?>" class="delete modal-trigger"><i
                                    class="material-icons tiny red-text">clear</i> Remove</a> </span>
                    </li>
                    ...
                    <div id="modal<?php echo $row4['id']; ?>" class="modal">
                        ...
                        <div class="modal-footer">
                            <a href="delete_comment.php?id=<?php echo $row4['id']; ?>"
